...
KYB.PermissionManagerPanel = function () {
    var RoleTree = new Ext.tree.TreePanel({
        ...
        loader: new Ext.tree.TreeLoader({
            dataUrl: context + '/role/queryRole',
        ...
        listeners: {
            click: function (node) {
                Ext.Ajax.request({
                    url: context + '/role/queryRoleById',
                    method: 'POST',
                    params: {
    ...
    function addRole() {
        ...
        function doSave() {
            ...
            Ext.Ajax.request({
                url: context + '/role/saveOrUpdateRole',
                method: 'POST',
                jsonData: formData,
                callback: function (opts, suc, res) {
                    var ds = Ext.decode(res.responseText);
