...
import org.hepx.proext.dao.UserInfoDao;
import org.hepx.proext.entity.TbRole;
import org.hepx.proext.entity.TbUserInfo;
...
import org.hepx.proext.util.MD5Util;
...
public class UserInfoService {
	...
	private void addLoginLogs(String user) throws Exception {
		...
		logsService.saveLogsPojo(logsPojo);
	}
	...
	private String builUrl(String md5_uid, String md5_ein) throws Exception {
		...
		int port = request.getLocalPort()==0?8088:request.getLocalPort();
		String host = request.getLocalAddr().equals("0.0.0.0")?"localhost":request.getLocalAddr();
		String info = "/proext/main/modifyInitPwd?uid=" + md5_uid
				+ "&ein=" + md5_ein;
